                        ...
                        <div class="row justify-content-center">
                            ...
                            @include ('admin.partials.message')
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('category_update', $cat->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf  
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="name" class="form-control py-4" id="name" type="text" value="{{$cat->name}}">
                                                    </div>
                                                </div>
