...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{URL('admin/vendors/iconfonts/ionicons/dist/css/ionicons.css')}}">
    <link rel="stylesheet" href="{{URL('admin/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css')}}">
    <link rel="stylesheet" href="{{URL('admin/vendors/css/vendor.bundle.base.css')}}">
    <link rel="stylesheet" href="{{URL('admin/vendors/css/vendor.bundle.addons.css')}}">

    <link rel="stylesheet" href="{{URL('admin/css/shared/style.css')}}">
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{URL('admin/css/demo_1/style.css')}}">
    <!-- End Layout styles -->
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{URL('admin/images/logo.svg')}}" alt="logo" /> </a>
...
@yield('content')
      ...
      <!-- partial:partials/_footer.html -->
          ...
          <!-- inject:js -->
          <script src="{{URL('admin/js/shared/off-canvas.js')}}"></script>
          <script src="{{URL('admin/js/shared/misc.js')}}"></script>
          <!-- endinject -->
          <!-- Custom js for this page-->
          <script src="{{URL('admin/js/demo_1/dashboard.js')}}"></script>
